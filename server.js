...
app.post("/saveTemplate", (req, res) => {
  ...
  fs.writeFile(filePath, html, (err) => {
    if (err) {
      ...
      return res.status(500).send("Failed to save template");
    }
...
//   // // Iterate over the componentsWithSeq array
//   // componentsWithSeq.forEach((component, index) => {
//   //     // Check if the component type is "table"
//   //     if (component.ComponentType === "table") {
//   //         // Generate HTML for the table
...
//   //         // Write the HTML for the table into a new file
//   //         const filePath = path.join(__dirname, 'templates', 'layout.html');

//   //             try {
//   //                 fs.writeFileSync(filePath, tableHTML);
//   //                 console.log('Table HTML written to file successfully.');
//   //                 res.status(200).send('Table HTML written to file successfully.');
//   //             } catch (err) {
//   //                 console.error('Error writing table HTML to file:', err);
//   //                 res.status(500).send('Error writing table HTML to file.');
//   //             }
